...
if (!$_POST['title']||!$_POST['url']||!$_POST['time']||!$_POST['content']||!$_POST['ip']) 
{
	echo "请输入一条完整的新闻。<br>";
...
{		//判断提交按钮是否存在
	...
	$insert=mysqli_query($conn,"insert into news(title,url,ip,time,content) values('$title','$url','$ip','$time','$content')");		//执行添加操作
